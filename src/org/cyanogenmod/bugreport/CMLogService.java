...
public class CMLogService extends IntentService {
    ...
    private void notify(CharSequence message, int iconResId, boolean withProgress, boolean ongoing) {
    ...
    private void notifyUploadFailed(int reasonResId) {
        ...
        notify(getString(R.string.error_upload_failed, reason), R.drawable.ic_launcher, false, false);
    }
